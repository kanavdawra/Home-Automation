...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>Dashboard</a>
  <ul>
    ...
    <li class="submenu active" > <a href="#"><i class="icon icon-tags"></i> <span>Clusters</span> <span class="label label-important" style="background-color: #ffb848;"><?php include('countcluster.php');?></span></a>
      <ul>
...
$sql = "SELECT id,name, cluster, color, icon,currstate,address FROM home WHERE cluster='$cluste'";
