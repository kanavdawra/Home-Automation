...
<!--Header-part-->
<a href="dashboard.php"><div id="header" >
  <h1>Matrix Admin</h1>
</div></a>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>Dashboard</a>
  <ul>
    <li class="active"><a href="dashboard.php"><i class="icon icon-home"></i> <span>Dashboard</span><span class="label label-important" style="background-color: #2255a4;"><?php include('countall.php')?></span></a> </li>
