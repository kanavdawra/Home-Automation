...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>Dashboard</a>
  <ul>
    ...
    <li  class="active"> <a href="delete.php"><i class="icon icon-trash"></i> <span>Delete Probe</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="delete.php" class="current">Delete Probes</a></div>
  </div>
<!--End-breadcrumbs-->
