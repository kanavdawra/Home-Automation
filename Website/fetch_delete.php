...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<li style="background-color:'.$color.' " > <a href="deleteprobe.php?id='.$id.'"> <i class="'.$icon.'"></i><i class="'.$currstate.' pull-left" style="position: relative;font-size:15px;top:-45px;right:30px;"></i> <span class="label label-success">'.$cluster.'</span><i class="icon-remove-sign pull-right" style="position: relative;font-size:15px;top:10px;right:-30px;"></i>'.$name.'</a> </li>';
