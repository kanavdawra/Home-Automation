...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="onlineprobe.php"><i class="icon icon-eye-open"></i> <span>Online Probe</span><span class="label label-success"style="background-color: #468847;"><?php include('countonline.php')?></span></a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="onlineprobe.php" class="current">Online Probes</a></div>
  </div>
<!--End-breadcrumbs-->
